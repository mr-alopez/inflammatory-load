# Dietary Inflammatory Load — Normative Spec v1.8

**Supersedes:** v1.7. The first findings from real use rather than review, all three from
...
2b. **Scoopable solids.** A solid entered by volume converts to mass through
    ...
    **Order.** Step 2 is tried before step 2b. A product with a liquid class converts at its
    liquid density; `BDMAP-1` is consulted only when no liquid class resolves. A product
    resolving under neither is not enterable by volume.
