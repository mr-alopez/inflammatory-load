# Dietary Inflammatory Load — Normative Spec v1.9

**Supersedes:** v1.8. Answers to the v1.8 report. §6.1b renders the quantity as entered —
...
- **Storage: IndexedDB**, not localStorage. §8.4 requires immutable per-entry snapshots plus
  ...
  Schema is versioned with an explicit migration path. `SCHEMA-3 → SCHEMA-4` adds `combo_id`
